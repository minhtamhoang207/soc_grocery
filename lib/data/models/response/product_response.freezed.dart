...
class _$_ProductResponse implements _ProductResponse {
  ...
  @override
  String toString() {
    return 'ProductResponse(id: $id, name: $name, description: $description, price: $price, quantity: $quantity, categories: $categories, imageUrls: $imageUrls, rating: $rating, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
