...
class ExploreView extends GetView<ExploreController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              children: [
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    padding:
                        const EdgeInsets.only(left: 25, right: 15, bottom: 20),
                    gridDelegate:
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      CategoryResponse category = controller.listCategory
                          .value[index];
                      return Container(
        ...
        //       CategoryResponse category = controller.listCategory.value[index];
        //       return ListTile(
